...
@Deprecated
public class OldBanCommand extends CommandHandler {
	private static Ban ban;

	public OldBanCommand(final Ban banModule) {
		super(banModule);
		ban = banModule;
	}
	...
	public static void handleBanCommand(final BATCommand command, final boolean global, final boolean ipBan,
		...
		BungeeAdminToolsPlugin.broadcast(returnedMsg, PermissionManager.Action.BAN_BROADCAST.getPermission());
	}
